...
namespace DentistAppointmentSystem.Data
{
    public static class DbInitialiser
    {
        ...
        //     // string[] roles = new string[] { "Admin", "User", "Receptionist", "Dentist" };
        ...
        //     var adminUser = await userManager.FindByEmailAsync("admin@dentist.com");
        //     if (adminUser == null)
        //     {
        ...
        //         {
        //             UserName = "JohnLock",
        //             Email = "JohnLock@brightsmile.com",
        //             FirstName = "John",
        //             LastName = "Lock",
        //             EmailConfirmed = true
        //         };

        //         var result = await userManager.CreateAsync(dentist, "Secret123!");
        //         if (result.Succeeded)
        //         {
        //             Console.WriteLine("{dentist.FirstName} user created.");
        //             await userManager.AddToRoleAsync(dentist, "Dentist");
        //         }
        //         else
        //         {
        //             Console.WriteLine($"Failed to create Dentist user: {string.Join(", ", result.Errors.Select(e => e.Description))}\n");
        //         }
        //     }
